...
type CustomerServiceClient interface {
	...
	GetCustomerByUserId(ctx context.Context, in *GetCustomerByUserIdRequest, opts ...grpc.CallOption) (*GetCustomerByUserIdResponse, error)
...
func (c *customerServiceClient) GetCustomerByUserId(ctx context.Context, in *GetCustomerByUserIdRequest, opts ...grpc.CallOption) (*GetCustomerByUserIdResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(GetCustomerByUserIdResponse)
	err := c.cc.Invoke(ctx, CustomerService_GetCustomerByUserId_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type CustomerServiceServer interface {
	...
	// Get customer profile by user ID
	GetCustomerByUserId(context.Context, *GetCustomerByUserIdRequest) (*GetCustomerByUserIdResponse, error)
	// Update customer profile
...
func (UnimplementedCustomerServiceServer) GetCustomerByUserId(context.Context, *GetCustomerByUserIdRequest) (*GetCustomerByUserIdResponse, error) {
...
func _CustomerService_GetCustomerByUserId_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetCustomerByUserIdRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CustomerServiceServer).GetCustomerByUserId(ctx, req.(*GetCustomerByUserIdRequest))
	}
	return interceptor(ctx, in, info, handler)
}
